  ...
  describe("When logged in", function () {
    ...
    describe("and a blog exists", function () {
      ...
      it("a blog can be liked", function () {
        cy.contains("blog title blog author").parent().contains("view").click();
        cy.contains("blog title blog author")
          .parent()
          .find(".like-button")
          .click();
        cy.contains("blog title blog author").parent().contains("likes 1");
      });
      ...
      describe("another user exists and it creates another blog", function () {
        ...
        it("blogs are ordered", function () {
          cy.get(".blog").eq(0).should("contain", "second blog second author");
          ...
          cy.get(".blog").eq(1).should("contain", "second blog second author");
        });
      });
    });
  });
